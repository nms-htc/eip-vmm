...
public final class UserAgentInfo {
    ...
    public boolean isMobileDevice() {
        return isIphone || isAndroidPhone || isTierTablet
                || isTierIphone || isTierRichCss || isTierGenericMobile;
    }
    ...
    public boolean detectIphone() {
        return !detectIpad()
                && userAgent.contains(deviceIphone)
                && !detectIpod();
    }
    ...
    public boolean detectWindowsMobile() {
        ...
        if (userAgent.contains(deviceWinMob)
                || userAgent.contains(deviceWinMob)
    ...
    public boolean detectBlackBerryWebKit() {
        return detectBlackBerry()
                && userAgent.contains(engineWebKit);
    }
    ...
    public boolean detectPalmOS() {
        ...
        if (userAgent.contains(devicePalm)
    ...
    public boolean detectMobileQuick() {
        ...
        if ((userAgent.contains(engineNetfront))
    ...
    public static UserAgentInfo createInstance() {
        ...
        if (userAgent != null & accept != null) {
            userAgentInfo = new UserAgentInfo(userAgent, accept);
        }
